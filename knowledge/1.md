Core Technical Analysis Skills
...
Wicks (Shadows): Long wicks represent a battle between buyers and sellers. For example, a long upper wick is bearish because it shows buyers pushed the price up, but sellers were strong enough to force it back down before the close.
...
The 2:1 Profit/Loss Ratio: A crucial rule for longevity is to always aim for a trade where the potential profit is double the risk (e.g., risking $10 to make $20).

Why it matters: If you maintain a 2:1 ratio, you only need to be right 33% of the time to break even. If your ratio is 1:1, you need 50% accuracy. If you risk $2 to make $1 (a negative ratio), you need 66% accuracy just to survive.

Quality over Quantity: The strategy focuses on taking fewer, high-quality setups where the indicators align, rather than overtrading on weak signals.
...
Avoiding the Negative Loop: Jumping in too early leads to losses, which destroys confidence and leads to "blowups" (losing the entire account).